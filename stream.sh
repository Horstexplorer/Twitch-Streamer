...
sleep 5
ffmpeg -stream_loop -1 -re -i stream.mp4 -vcodec libx264 -crf 30 -preset medium -tune film  -tune fastdecode -b:v 3M -maxrate 8M -minrate 2M -bufsize 2M -ar 44100 -f flv rtmp://live.twitch.tv/app/<<streamkey>>
